...
<div class="min-h-screen bg-base-200">
	...
	<aside
		class="top-0 left-0 fixed flex h-screen w-{sb_wide} flex-col border-r border-base-300 bg-base-200"
	>
	...
	<main class="ml-{sb_wide} min-h-screen bg-base-200 text-base-content">
		{@render children?.()}
	</main>
</div>
